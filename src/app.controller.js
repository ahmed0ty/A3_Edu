...
export const bootstrap = async () => {
  ...
  app.get("/clear-cache", async (req, res, next) => {
    try {
      await clearCacheByPrefix("courses:");
      await clearCacheByPrefix("course:");
      await clearCacheByPrefix("lessons:");
      await clearCacheByPrefix("lesson:");
      await clearCacheByPrefix("quizzes:");
      await clearCacheByPrefix("quiz:");
      await clearCacheByPrefix("myCourses:");
      await clearCacheByPrefix("quizResults:");
